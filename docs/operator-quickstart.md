# Operator Quickstart — Repair of furniture and home furnishings

Shortest path from clone to a verified local dry-run for **ISIC 9524** (`cloud-itonami-isic-9524`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9524.git
cd cloud-itonami-isic-9524
```
...
- Likely source path: `furniture.governor.cljc`
