(ns furniture.operation
  ...
  when the governor is clean -- see `furniture.phase`."
  (:require [langgraph.graph :as g]
            [langgraph.checkpoint :as cp]
            [furniture.repairopsllm :as repairopsllm]
            [furniture.governor :as governor]
...
(defn build
  ...
  opts:
    :advisor      -- a `furniture.repairopsllm/Advisor` (default: mock-advisor)
